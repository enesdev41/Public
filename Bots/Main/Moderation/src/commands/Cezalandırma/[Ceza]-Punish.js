...
new MessageButton().setCustomId("bir").setLabel("1").setStyle("SECONDARY"),
new MessageButton().setCustomId("iki").setLabel("2").setStyle("SECONDARY"),
new MessageButton().setCustomId("üç").setLabel("3").setStyle("SECONDARY"),
new MessageButton().setCustomId("iptal").setEmoji("1083677131285991474").setLabel("X").setStyle("SECONDARY")
);
