...
const { ramalcimnitro, ramalcimnetflix, ramalcimspotify, ramalcimexxen, ramalcimblutv, ramalcimyoutube, star } = require("../../../../src/configs/emojis.json")
...
\` ⦁ \` Eğer \`@Çekiliş Katılımcısı\` Rolünü alırsanız sunucumuzda sıkça vereceğimiz ${ramalcimnitro} , ${ramalcimspotify} , ${ramalcimyoutube} , ${ramalcimnetflix} , ${ramalcimexxen} ve daha nice ödüllerin bulunduğu çekilişlerden haberdar olabilirsiniz. 
                ...
                "components": [{
                    "type": 1, "components": [{
                        "type": 3, "custom_id": "renk", "options": [
                            ...
                            { "label": "Sarı", "description": "Yeşil rengine sahip olmak için tıkla!", "value": "sari", "emoji": { "name": "🍋" }, },
...
const etkinlik = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.etkinlik)).id
const cekilis = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.cekilis)).id
...
const koç = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.koç)).id
const boğa = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.boğa)).id
const ikizler = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.ikizler)).id
const yengeç = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.yengeç)).id
const aslan = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.aslan)).id
const başak = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.başak)).id
const terazi = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.terazi)).id
const akrep = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.akrep)).id
const yay = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.yay)).id
const oğlak = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.oğlak)).id
const kova = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.kova)).id
const balık = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Burçlar.balık)).id
...
const csgo = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.csgo)).id
const lol = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.lol)).id
const valorant = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.valorant)).id
const gta5 = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.gta5)).id
const pubg = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.pubg)).id
const fortnite = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Oyunlar.fortnite)).id
...
const kirmizi = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.kirmizi)).id
const turuncu = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.turuncu)).id
const mor = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.mor)).id
const yesil = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.yesil)).id
const sari = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.Renkler.sari)).id
...
if (interaction.customId === "renk") {
        ...
        let renkroller = [kirmizi, turuncu, mor, yesil]
...
const sevgili = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.İlişkiler.couple)).id
const yalnız = await client.guilds.cache.get(allah.GuildID).roles.cache.find(x => x.name.includes(ayar.İlişkiler.alone)).id
