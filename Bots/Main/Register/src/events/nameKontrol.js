...
module.exports = async (oldMember, newMember) => {
    ...
    if (newMember.guild.channels.cache.find(c => c.name === "name_log")) newMember.guild.channels.cache.find(c => c.name === "name_log").send({ embeds: [Jaylen] });
