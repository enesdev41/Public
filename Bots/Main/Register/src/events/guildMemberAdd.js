...
Merhaba ${member} **${member.guild.name}** Sunucumuza Hoş Geldin Seninle beraber ${üyesayısı} üye sayısına ulaştık
...
${member.guild.name} sunucu Özel URL'si tarafından davet edildin. Kayıt işleminden sonra ${kurallar} kanalına göz atmayı unutmayın.
`});
channel.wsend({ content:`${member}, sunucuya katıldı! Davet Eden: **Sunucu Özel URL** Sunucumuz **${member.guild.memberCount}** Uye sayisine ulaşti :tada:`})
return }
...
${usedInvite.inviter} üyesi tarafından davet edildin. Kayıt işleminden sonra ${kurallar} kanalına göz atmayı unutmayın.
`});
channel.wsend({ content:`${member}, ${usedInvite.inviter.tag} davetiyle katıldı! Uyenin Davet Sayisi (**${total}**) Sunucumuz **${member.guild.memberCount}** Uye sayisine ulaşti`})
}
